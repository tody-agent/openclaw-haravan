...
Danh sách tool chi tiết nằm ở [ma trận playbook](/openclaw-lean/playbook-tool-matrix) và trong skill [openclaw-haravan-ops](https://github.com/tody-agent/haravan-master-ecosystem/tree/main/skills/openclaw-haravan-ops).

Nếu bạn muốn xem bản tổng hợp đầy đủ hơn về **năng lực tổng thể, use case, sự khác nhau giữa full MCP và OpenClaw lean theo từng nhóm trách nhiệm**, đọc thêm [Năng lực & use case của bộ kit](/openclaw-kit/nang-luc-va-use-cases-theo-vai-tro).
:::
...
3. **Số thuế & lãi lỗ:** Coi là **hỗ trợ quyết định**, không thay **kế toán** — xem [disclaimer](/openclaw-lean/safety-disclaimers).

Nếu bạn đang chuẩn bị **demo có dữ liệu mẫu**, seed trước bằng runbook tại [Seed dữ liệu demo & kịch bản trình diễn](/openclaw-kit/demo-seed-va-kich-ban-demo).
...
Luôn yêu cầu AI: **chỉ sửa trên bản nháp**, **xem trước**, và **bạn xác nhận** trước khi áp dụng. Đọc thêm [an toàn theme](/openclaw-lean/safety-disclaimers).
:::
...
- [Cài đặt nếu chưa xong](/openclaw-kit/cai-dat-va-thiet-lap)  
- [FAQ & xử lý sự cố](/openclaw-kit/cau-hoi-thuong-gap)  
